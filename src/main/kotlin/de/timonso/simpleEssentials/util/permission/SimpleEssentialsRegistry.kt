package de.timonso.simpleEssentials.util.permission

import dev.slne.surf.surfapi.bukkit.api.permission.PermissionRegistry

object SimpleEssentialsRegistry : PermissionRegistry() {
    private const val PREFIX = "simpleessentials"
    ...
    val SIMPLEESSENTIALS_COMMAND = create("$PREFIX.command")
